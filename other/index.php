...
<head>
    ...
    <title>National Greening Program</title>
    <meta name="robots" content="noindex, follow" />
    <meta name="description" content="SENIOR IT SUPPORT SPECIALIST APPLICATION">
    <meta name="author" content="Jems Rey Soto">
...
<div class="body-wrapper">
                                    ...
                                    <ul>
                                        ...
                                        <li class="menu-icon"><a href="#">About</a>
                                            <ul>
                                                ...
                                                <li><a href="#">Expected Project Outcome</a></li>
                                                <li><a href="#">Strategies</a></li>
                                                <li><a href="#">Commodity Roadmap</a></li>
                                                <li><a href="#">NGP Logo</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-icon"><a href="#">Reference</a>
                                            <ul>
                                                <li><a href="#">Issuances & Legal Bases</a></li>
                                                <li><a href="#">Memorandum of Agreement</a></li>
                                                <li><a href="#">NSIC Registered Varieties</a></li>
                                            </ul>
                                        </li>
                                        ...
                                        <li class="menu-icon"><a href="#">Events & Stories</a>
                                            <ul>
                                                <li><a href="#">Bamboo Month</a></li>
                                                <li><a href="#">ENGP Stories</a></li>
                                                <li><a href="#">Regional Stories</a></li>
                                                <li><a href="#">Regional Gallery</a></li>
                                            ...
                                            <ul class="mega-menu">
                                                ...
                                                <li class="nav-item dropdown">
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownAbout">
                                                        <li><a class="dropdown-item" href="#">Bamboo Month</a></li>
                                                        <li><a class="dropdown-item" href="#">ENGP Stories</a></li>
                                                        <li><a class="dropdown-item" href="#">Regional Stories</a></li>
                                                        <li><a class="dropdown-item" href="#">Regional Gallery</a></li>
    ...
    <div class="ltn__slider-area ltn__slider-3  section-bg-1">
        <div class="ltn__slide-one-active slick-slide-arrow-1 slick-slide-dots-1 arrow-white">
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2 ltn__slide-item-3 ltn__slide-item-3-normal text-color-white bg-image" data-bg="img/slider/11.jpg">
            ...
            <!-- ltn__slide-item -->
            <div class="ltn__slide-item ltn__slide-item-2 ltn__slide-item-3 ltn__slide-item-3-normal text-color-white bg-image" data-bg="img/slider/12.jpg">
